...
const TYPE_ICONS: Record<SlideType, string> = {
  ...
  clip_dialogue_game: '🎞️', clip_comprehension: '❓', clip_vocab_match: '🔗', clip_predictions: '🔮', clip_production: '🗣️', friendlyflix_end: '🎬',
};
...
const TYPE_LABELS: Record<SlideType, string> = {
  ...
  clip_dialogue_game: 'Juego de diálogo (clip)', clip_comprehension: 'Comprensión (clip)', clip_vocab_match: 'Vocab match (clip)', clip_predictions: 'Predicciones (clip)', clip_production: 'Producción libre (clip)', friendlyflix_end: 'Fin Friendlyflix®',
};
