...
const TYPE_LABEL: Record<SlideType, string> = {
  ...
  video: 'Video', cloze_test: 'Cloze', image_hotspot: 'Hotspot', sorting: 'Clasificar', lyrics: 'Letra de canción',
  song_cover: 'Portada canción', vocab_match: 'Vocab matching', predictions: 'Predicciones',
  ...
  clip_dialogue_game: 'Juego diálogo (Friendlyflix®)', clip_comprehension: 'Comprensión (Friendlyflix®)', clip_vocab_match: 'Vocab match (Friendlyflix®)', clip_predictions: 'Predicciones (Friendlyflix®)', clip_production: 'Producción libre (Friendlyflix®)', friendlyflix_end: 'Fin Friendlyflix®',
};
