...
const TYPE_LABEL: Record<SlideType, string> = {
  ...
  clip_dialogue_game: 'Juego diálogo (Friendlyflix®)', clip_comprehension: 'Comprensión (Friendlyflix®)', clip_production: 'Producción libre (Friendlyflix®)', friendlyflix_end: 'Fin Friendlyflix®',
};
